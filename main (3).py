...
saved = int(input("Enter how much you saved on your budget: "))
expense_1 = int(input("Enter how much you spent on transportation: "))
expense_2 = int(input("Enter how much you spent on consumables: "))
expense_3 = int(input("Enter how much you spent on other expenses: "))
if time == 1:
